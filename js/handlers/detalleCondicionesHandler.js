...
exports.handler = async (event) => {
    console.log('Detalle Condiciones Handler - Event received:', JSON.stringify(event, null, 2));
    ...
    try {
        ...
        // Consultar la tabla datos_condiciones por id_promociones_ttp
        const query = `
            SELECT * FROM public.datos_condiciones 
        ...
        return {
            ...
            body: JSON.stringify({
                message: 'Datos de condiciones obtenidos exitosamente',
        ...
        console.error('Error en detalleCondicionesHandler:', error);
