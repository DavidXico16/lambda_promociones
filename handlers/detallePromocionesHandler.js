...
exports.handler = async (event) => {
  console.log('Datos detalles Promociones, idFlujo : ', JSON.stringify(event, null, 2));
  ...
  try {
    ...
    return {
      ...
      headers,
      body: JSON.stringify({
        message: 'Datos obtenidos exitosamente de Promociones',
        data: result.rows[0]
      })
    };

  } catch (error) {
    console.error('Error en POST datos_promociones por el idFlujo:', error);
