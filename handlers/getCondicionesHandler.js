// handlers/getDatosCondicionesByIdHandler.js
...
exports.handler = async (event) => {
  console.log('GET Datos Condiciones by idFlujo - Event received:', JSON.stringify(event, null, 2));
  ...
  try {
    ...
    return {
      ...
      headers,
      body: JSON.stringify({
        message: 'Datos obtenidos exitosamente de datos_condiciones',
        data: result.rows[0]
      })
    };

  } catch (error) {
    console.error('Error en POST datos_condiciones por el idFlujo:', error);
